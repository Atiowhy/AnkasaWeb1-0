...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      axios
        .post('https://easy-lime-seal-toga.cyclic.app/auth/register', body)
        .then((res) => {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <div className="form-text">
                  <span onClick={handleEye} style={{ cursor: 'pointer' }}>
                    {eye ? 'Sembunyikan' : 'Tampilkan'} kata sandi
                  </span>
                </div>
              </div>
              <div>
                <button type="submit" className="btn mt-3 w-100 text-light">
                  Daftar
                </button>
